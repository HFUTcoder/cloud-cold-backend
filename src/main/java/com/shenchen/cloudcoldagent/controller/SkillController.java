...
public class SkillController {
    ...
    @GetMapping("/resources/{skillName}")
    public BaseResponse<SkillResourceListVO> listSkillResources(@PathVariable String skillName) throws IOException {
        return ResultUtils.success(skillService.listSkillResources(skillName));
    }
}
