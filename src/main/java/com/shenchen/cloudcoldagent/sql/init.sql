...
INSERT INTO user (id, userAccount, userPassword, userName, userAvatar, userProfile, userRole) VALUES
                                                                                                  ...
                                                                                                  (2, 'user', '10670d38ec32fa8102be6a37f8cb52bf', '普通用户', 'https://lf-flow-web-cdn.doubao.com/obj/flow-doubao/doubao/web/doubao_avatar.png', '我是一个普通用户', 'user'),
                                                                                                  (3, 'test', '10670d38ec32fa8102be6a37f8cb52bf', '测试账号', 'https://lf-flow-web-cdn.doubao.com/obj/flow-doubao/doubao/web/doubao_avatar.png', '这是一个测试账号', 'user');
